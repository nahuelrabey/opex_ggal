...
*(análisis del agente)*: Confirmado. He investigado esta hipótesis en la literatura institucional (FMI, BIS). **No se necesita que las grandes empresas quiebren**. Las quiebras masivas de PyMEs gatillan riesgo bancario por dos vías autónomas: el aumento brutal de los *Non-Performing Loans* (mora bancaria directa en bancos muy expuestos) y el colapso del "Crédito Comercial" (*Trade Credit Contagion*), donde la factura impaga de una PyME destruye la liquidez de todo su encadenamiento de proveedores. Ver desarrollo, fundamentos y fuentes en [`../analisis_mercado/riesgo_sistemico_pymes.md`](../analisis_mercado/riesgo_sistemico_pymes.md).
